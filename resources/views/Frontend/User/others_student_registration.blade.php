...
<style>
 ...
 <div class="form-section">
    <div class="section-title">
        <b>অন্য প্রতিষ্ঠানের শিক্ষার্থীদের নিবন্ধন ফরম</b>
    </div>
    <div class="container mt-4">
        @if(Session::get('success'))
            ...
            @endif
        <form method="post" enctype="multipart/form-data" action="{{url('/otherRegistration')}}" id="present_form">
            @csrf
            <div class="form-group row">
                ...
                <div class="col-lg-6 col-md-6 col-12" id="input-box">
                    <label>ফেনী সরকারি কলেজ হইতে পাশের সন</label>
                    <input type="text" name="passing_year" class="form-control" value="{{old('passing_year')}}">
                </div>
                <div class="col-lg-6 col-md-6 col-12" id="input-box">
                    <label>ফেনী সরকারি কলেজ এ সর্বশেষ অধ্যয়নরত শ্রেণী</label> <span></span>
                    <select class="form-control" name="passing_class" required>
                ...
                <div class="col-lg-6 col-md-6 col-12" id="input-box">
                    <label>বর্তমানে অধ্যয়নরত শ্রেণী</label> <span></span>
                ...
                <div class="col-lg-6 col-md-6 col-12" id="input-box">
                    <label>বিভাগ / বিষয় <span></span></label>
                ...
                <div class="col-lg-6 col-md-6 col-12" id="input-box">
                    <label>ভর্তির সন <span></span></label>
                ...
                <div class="col-lg-6 col-md-6 col-12" id="input-box">
                    <label>ক্লাস রোল / আইডি <span></span></label>
                    <input type="text" class="form-control" name="class_roll_id" value="{{old('class_roll_id')}}" required>
                    @error('class_roll_id')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-lg-6 col-md-6 col-12" id="input-box">
                    <label>রেজিষ্ট্রেশন নং (যদি থাকে) <span></span></label>
