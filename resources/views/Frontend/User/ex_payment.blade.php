    ...
    <div class="container mt-4">
     ...
     <button class="btn btn-primary btn-lg btn-block" id="sslczPayBtn"
                ...
                <div class="col-lg-12 col-md-12 col-12" id="input-box" style="text-align: center">
                    <span style="font-size: 15px;">[ বি:দ্র: - আপনি যদি রেজিষ্ট্রেশন ফি  এখন পরিশোধ করতে না চান তাহলে পরবর্তীতে আপনার ড্যাশবোর্ডে লগইন করে আপনার রেজিষ্ট্রেশন ফি পরিশোধ করবেন। রেজিষ্ট্রেশন ফি পরিশোধ ব্যাতিত রেজিষ্ট্রেশন গ্রহণ করা হবে না। আপনার ড্যাশবোর্ডে <a href="{{url('/student_login')}}">লগইন করুন</a>]</span>
                </div>
            </div>
        </div>
    </div>
