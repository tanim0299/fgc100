        ...
        <form method="post" enctype="multipart/form-data" action="{{url('/ex_registration')}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3 col-md-3 col-6" id="input-box">
                    ...
                    <input type="text" class="form-control" name="session" value="{{old('session')}}" placeholder="EX:2008-2009">
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-12" id="input-box">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-12" id="input-box" style="text-align: center">
                    <span style="font-size: 15px;">[ বি:দ্র: - রেজিষ্ট্রেশন সম্পন্ন হওয়ার পর লগইন করে আপনার রেজিষ্ট্রেশন ফি পরিশোধ করুন । অন্যথায় আপনার রেজিষ্ট্রেশন  বাতিল বলে গণ্য করা হইবে । টেকনিক্যাল সমস্যার জন্য 01575434262 এই নাম্বারে যোগাযোগ করুন। ]</span>
                </div>
            </div>
        </form>
    </div>
