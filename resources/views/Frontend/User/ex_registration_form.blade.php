    ...
    <div class="container">
       ...
       <div class="content">
           <div class="instruction">
                ...
                <li>আবেদন ফরম পূরণ করার পর আবেদনকারীর মোবাইলে ইউজার আইডি এবং পাসওয়ার্ড প্রেরণ করা হবে। উক্ত ইউজার আইডি এবং পাসওয়ার্ড দিয়ে  লগইন করে ফরম পূরণের দিন বিকাশের মাধ্যমে রেজিস্ট্রেশন ফি প্রদান করতে হবে। অন্যথায় আবেদনটি গ্রহণযোগ্য হবে না। </li>

                <li>আবেদনকারী যদি তার পরিবারের সদস্যদের নিয়ে অনুষ্ঠানে অংশগ্রহণ করতে চান, আবেদনকারীসহ পরিবারের প্রত্যেক সদস্যদের জন্য জনপ্রতি ৪,০০০ ( চার হাজার ) টাকা করে ফি প্রদান করতে হবে।</li>
                <li>রেজিস্ট্রেশন ফি প্রদান করার পর আবেদনকারী আবেদন ফরমে যে মোবাইল নাম্বার দিবেন ওই নাম্বারে একটি অভিনন্দন ক্ষুদেবার্তা ও অর্থ প্রেরণের রশিদ যাবে।  এক্ষেত্রে আবেদনকারীকে জমাকৃত রশিদের সফট কপি বা প্রিন্ট কপি আমন্ত্রণপত্র ও উপহার সামগ্রী গ্রহণের জন্য প্রদর্শন করতে হবে।</li>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3 col-md-3 col-6" id="input-box">
                    ...
                    <select class="form-control @error('last_class') is-invalid @enderror" name="last_class" required>
                        ...
                        <option {{old('last_class') === 'Masters' ? 'selected' : ''}} value="Masters">মাষ্টার্স</option>
                    </select>
                    @error('last_class')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
